...
export const PROFILE = {
  ...
  bio: {
    en: [
      "Software Engineering Manager with 10+ years of experience designing and delivering high-impact products across fintech, logistics, SaaS, and government sectors. Currently at Esquitechs, I bridge technical depth with product vision — leading distributed teams, architecting cloud-native systems, and shipping full-stack solutions that scale.",
  ...
  highlights: {
    en: [
      ...
      "Full stack: Laravel · Go · Next.js · React",
      "AI/LLM integrations & automation pipelines",
      "Blockchain & smart contract development",
      "DevOps: Docker, K8s, CI/CD, AWS/GCP",
    ],
    es: [
...
export const EXPERIENCE = [
  {
    ...
    description: {
      en: "Lead engineering teams across multiple client projects, defining technical direction, architecture decisions, and delivery processes. Built and scaled SaaS platforms, REST APIs, and AI-integrated workflows. Key technologies: Laravel, Go, Next.js, Docker, AWS.",
      es: "Lidero equipos de ingeniería en múltiples proyectos de clientes, definiendo dirección técnica, decisiones de arquitectura y procesos de entrega. Construí y escalé plataformas SaaS, APIs REST y flujos integrados con IA. Tecnologías clave: Laravel, Go, Next.js, Docker, AWS.",
    },
    tags: ["Laravel", "Go", "Next.js", "AWS", "Team Leadership"],
  },
  {
    id: "fullstack-dev",
    ...
    location: "México",
    description: {
      en: "Delivered full-stack web applications and REST APIs for clients across logistics, fintech, and e-commerce. Introduced CI/CD pipelines, Docker containerization, and automated testing — reducing deployment time by 60%.",
      es: "Entregué aplicaciones web full-stack y APIs REST para clientes en logística, fintech y e-commerce. Introduje pipelines de CI/CD, contenedorización con Docker y pruebas automatizadas — reduciendo el tiempo de despliegue en un 60%.",
    },
    tags: ["PHP", "Laravel", "Vue.js", "Docker", "MySQL"],
  },
  {
    id: "backend-dev",
    ...
    location: "México",
    description: {
      en: "Built and maintained backend services for enterprise clients, primarily using PHP/Laravel and PostgreSQL. Contributed to microservices architecture migrations and API integrations with third-party platforms.",
      es: "Construí y mantuve servicios backend para clientes empresariales, principalmente con PHP/Laravel y PostgreSQL. Contribuí a migraciones de arquitectura de microservicios e integraciones de API con plataformas de terceros.",
    },
